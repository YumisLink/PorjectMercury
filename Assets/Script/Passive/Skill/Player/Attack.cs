...
public class Attack : Skill
{
    ...
    public void Atk()
    {
        if (RushAttack)
        {
            ...
            go.SetDamage(new Damage(1.20f * role.Properties.Attack, DamageType.Normal));
        ...
        {
            var go = Effect.Create(GameManager.Effect[1],gameObject, transform.position);
            go.SetDamage(new Damage(0.70f * role.Properties.Attack, DamageType.Normal));
